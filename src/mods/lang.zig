...
pub fn zigVer(alloc: std.mem.Allocator) []const u8 {
...
pub fn pyVer(alloc: std.mem.Allocator) []const u8 {
...
pub fn rustVer(alloc: std.mem.Allocator) []const u8 {
...
pub fn nodeVer(alloc: std.mem.Allocator) []const u8 {
